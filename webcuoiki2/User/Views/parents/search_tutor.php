...
<body>
	...
	<div class="container">
      <a href="?controller=trangchu" ><i class="fas fa-arrow-left"></i>Trang chủ
    </div></a>
 			<h3 class="display-3" style="text-align: center;">Danh sách gia sư </h3>
      <form action="" method="GET">
                            
       <input type="hidden" name="controller" value="phuhuynh">
      <input type="text" name="tukhoa" placeholder="Tên thầy cô/Môn học/Lớp học" style="width: 30%; height: 50px;"> 
          ...
          ?>
              <div class="column">
                ...
                <div >
                  ...
                  <div class="dk" >
                    <button> <a href="?controller=phuhuynh&action=dangKygiaSu&id=<?php echo $value['id'] ?>" style="color: white;">Đăng Ký</a></button>      
