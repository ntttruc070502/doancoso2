	 	...
	 	<?php 
              ...
              <div class="column">
                ...
                <div >				
                    ...
                    <small><a  href="index.php?controller=admin&action=listParent&id=<?php echo $value['id'] ?>" class="btn btn-success" name="accept">Phụ huynh đã đăng ký  <i  class="fa fa-pencil"></i></a></small>
