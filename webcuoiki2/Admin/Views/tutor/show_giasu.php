   ...
   <div class="chua">
        ...
        ?>
              <div class="column">
                ...
                <div >              
                            <small><a  href="?controller=admin&action=accept&id=<?php echo $value['id'] ?>" class="btn btn-primary" name="accept">Xem  <i  class="fa fa-pencil"></i></a></small>                        
            ...
            if ($current_page > 1 && $total_page > 1) {
                echo "<a style='margin:0 10px' href='user?controller=admin&action=list&page=" . ($current_page - 1) . "'><<</a>";
            }
            ...
            for ($i = 1; $i <= $total_page; $i++) {
                if ($i == $current_page) {
                    ...
                    echo '<a href="user?controller=admin&action=list&page=' . $i . '">' . $i . '</a>';
                }
            }

            if ($current_page < $total_page && $total_page > 1) {
                echo '<a href="user?controller=admin&action=list&page=' . ($current_page+1) . '">>></a>';
            }
            ?>
    </div>
