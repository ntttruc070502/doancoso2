          ...
          ?>
              <div class="column">
                ...
                <div class="col-sm-3">     
                    ...
                    <div class="row">                     
                      <div >
                        <p class="card-title ten">Tên phụ huynh:<?= $value['tenphuhuynh'] ?></p>
                        <p class="card-title ten">Địa chỉ:<?= $value['diachi'] ?></p>
                        <p class="card-title ten">Sđt:<?= $value['sdtphuhuynh'] ?></p>
                        <p class="card-title ten">Lớp học:<?= $value['lophoc'] ?></p>
                        <p class="card-title ten">Lịch học:<?= $value['lichhoc'] ?></p>               
                      </div>
                <div >
                </div>                        
              </div> 
            <div class="dk" >
                    <button> <a href="?controller=admin&action=sendemail&idphuhuynh=<?php echo $value['idphuhuynh'] ?>" style="color: white;" name="send">Gửi email cho gia sư</a></button>
              </div>  
              </div>
                <?php 
